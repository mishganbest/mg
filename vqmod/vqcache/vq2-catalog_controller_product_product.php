	...
	public function index() { 
		...
		$this->data['video'] = $product_info['video'];
			...
			if ($product_info['quantity'] <= 0) {
				$this->data['stock'] = '<span style="color: red">' .$product_info['stock_status']. '</span>';
			} elseif ($this->config->get('config_stock_display')) {
				$this->data['stock'] = $product_info['quantity'];
			} else {
				$this->data['stock'] = '<span style="color: #99cc00">' .$this->language->get('text_instock'). '</span>';
			}
...
,'price_full'              => $option_value['price_full'],
			...
			$this->data['option_stock'] = $product_info['stock_status'];
