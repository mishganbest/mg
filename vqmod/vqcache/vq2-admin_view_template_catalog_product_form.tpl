    ...
    <div class="content">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
	      ...
	      <tr>
                  <td><?php echo $entry_short_pulscen; ?></td>
                      <td><textarea name="product_description[<?php echo $language['language_id']; ?>][short_pulscen]" cols="100" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['short_pulscen'] : ''; ?></textarea></td>
              </tr>
		<tr>
                  <td><?php echo $entry_pulscen_description; ?></td>
                      <td><textarea name="product_description[<?php echo $language['language_id']; ?>][pulscen_description]" cols="100" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['pulscen_description'] : ''; ?></textarea></td>
              </tr>
		<tr>
                  <td><?php echo $entry_blizko_description; ?></td>
                      <td><textarea name="product_description[<?php echo $language['language_id']; ?>][blizko_description]" cols="100" rows="5"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['blizko_description'] : ''; ?></textarea></td>
              </tr>
              <tr>
		...
		<tr>
              <td><?php echo $entry_rate_stock; ?></td>
              <td><input type="text" name="rate_stock" value="<?php echo $rate_stock; ?>" size="2" /></td>
            </tr>
            <tr>
        ...
        <div id="tab-option">
		  ...
		  <td class="right"><?php echo $entry_option_sku; ?></td>
		  <td class="right"><?php echo $entry_rate_stock; ?></td>
                  <td></td>
                </tr>
              </thead>
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="right"><input type="hidden" value="+" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][price_prefix]">
		...
		<td class="right">
                    <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_sku]" value="<?php echo $product_option_value['option_sku']; ?>" /></td>
	
		<td class="right">
                    <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][rate_stock]" value="<?php echo $product_option_value['rate_stock']; ?>" size="3" /></td>
...
$('input[name=\'option\']').catcomplete({
	...
	select: function(event, ui) {
		...
		if (ui.item.type == 'select' || ui.item.type == 'radio' || ui.item.type == 'checkbox' || ui.item.type == 'image') {
			...
			html += '        <td class="right"><?php echo $entry_option_sku; ?></td>';
			html += '        <td class="right"><?php echo $entry_rate_stock; ?></td>';
			html += '        <td></td>';
			html += '      </tr>';
			html += '  	 </thead>';
			html += '    <tfoot>';
...
function addOptionValue(option_row) {	
	...
	html += '      <option value="0"><?php echo $text_no; ?></option>';
	html += '    </select></td>';
	html += '    <td class="right"><input type="hidden" value="+" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][price_prefix]">';
	...
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_sku]" value="" /></td>';
	html += '    <td class="right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][rate_stock]" value="" size="3" /></td>';
