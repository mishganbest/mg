...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons"><a onclick="window.open('<?php echo $blank; ?>');" class="button"><?php echo $button_blank; ?></a><a onclick="window.open('<?php echo $invoice; ?>');" class="button"><?php echo $button_invoice; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="button"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      ...
      <div id="tab-order" class="vtabs-content">
            ...
            <script type="text/javascript">
                $(function(){
                    $('#tab-order table').after('<div id="simple_custom_order"></div>');
                    $('#simple_custom_order').load('index.php?route=module/simple/custom&token=<?php echo $token; ?>&type=order&id=<?php echo $order_id; ?>');
                });
            </script>
