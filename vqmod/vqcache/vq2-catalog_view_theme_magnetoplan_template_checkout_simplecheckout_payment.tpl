        ...
        <table class="simplecheckout-methods-table">
            <?php foreach ($payment_methods as $payment_method) { ?>
                <tr>
                    ...
                    <td class="title">
                        <?php if( !empty($payment_method['image']) ) { ?><label for="<?php echo $payment_method['code']; ?>"><?php echo $payment_method['image']; ?></label><?php } else { ?><label for="<?php echo $payment_method['code']; ?>"><?php echo $payment_method['title']; ?></label><?php } ?>
                    </td>
                </tr>
