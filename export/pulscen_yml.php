...
//require_once(DIR_APPLICATION . 'controller/feed/pulscen_yml.php');

//$controller = new ControllerFeedPulscenYml($registry);
...
$action = new Action('feed/pulscen_yml/savetofile', array(dirname(__FILE__).'/pulscen_yml.xml'));
$controller->dispatch($action, '');
//$controller->saveToFile(dirname(__FILE__).'/pulscen_yml.xml');
?>
