...
//require_once(DIR_APPLICATION . 'controller/feed/blizko_yml.php');

//$controller = new ControllerFeedBlizkoYml($registry);
...
$action = new Action('feed/blizko_yml/savetofile', array(dirname(__FILE__).'/blizko_yml.xml'));
$controller->dispatch($action, '');
//$controller->saveToFile(dirname(__FILE__).'/blizko_yml.xml');
?>
