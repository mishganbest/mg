...
class ModelAccountOrder extends Model {
	...
	public function getOrderProductsStatistics($order_id) {
		$query = $this->db->query("SELECT op.order_product_id, op.name, op.price, op.quantity, op.tax, pov.option_sku, p.sku, ovd.name AS optname FROM " . DB_PREFIX . "order_product op LEFT JOIN " . DB_PREFIX . "order_option oo ON op.order_product_id = oo.order_product_id LEFT JOIN " . DB_PREFIX . "product_option_value pov ON oo.product_option_value_id = pov.product_option_value_id LEFT JOIN " . DB_PREFIX . "product p ON op.product_id = p.product_id LEFT JOIN " . DB_PREFIX . "option_value_description ovd ON pov.option_value_id = ovd.option_value_id WHERE op.order_id = '" . (int)$order_id . "'");
