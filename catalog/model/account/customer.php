...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$message .= sprintf($this->language->get('text_login_email'), $this->db->escape($data['email'])) . "\n";
		...
		$subject = sprintf($this->language->get('text_subject_customer_registration'), $this->config->get('config_name'));
		$text = sprintf($this->language->get('text_customer_registration'), $this->db->escape($data['email']));
