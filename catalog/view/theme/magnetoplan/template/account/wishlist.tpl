<?php echo $header; ?>
<?php if ($success) { ?>
<div class="success"><?php echo $success; ?><img src="catalog/view/theme/magnetoplan/image/close.png" alt="" class="close" /></div>
<?php } ?>
