<div id="cart">
  <div class="heading">
    <a class="cartlink" href="<?php echo $checkout; ?>"><?php echo $text_cart; ?></a><span id="cart-total" class="bold"><?php echo $text_items; ?></span></div>
  <div class="content">
