...
class ControllerFeedBlizkoYml extends Controller {
	private $shop = array();
...
//				$data['cbid'] = 15;
				...
				$data['url'] .= '?utm_source=marketplace&utm_medium=blizko';
...
//				$data['barcode'] = $product['sku'];
				...
				*/
				...
				if ($this->config->get('yandex_yml_attr_vs_description')) {
					...
					if ($product['blizko_description']) {
					$data['description'] = $product['blizko_description'];
					} else {
