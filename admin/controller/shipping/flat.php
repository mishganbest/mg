...
class ControllerShippingFlat extends Controller {
	...
	public function index() {   
		...
		if (isset($this->request->post['flat_threshold'])) {
			$this->data['flat_threshold'] = $this->request->post['flat_threshold'];
		} else {
			$this->data['flat_threshold'] = $this->config->get('flat_threshold');
		}
