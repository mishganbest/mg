...
class ControllerCatalogCategory extends Controller { 
	...
	private function getForm() {
		...
		$this->data['entry_table_show'] = $this->language->get('entry_table_show');
		$this->data['entry_table_tip'] = $this->language->get('entry_table_tip');
		$this->data['entry_table_poverhnost'] = $this->language->get('entry_table_poverhnost');
		$this->data['entry_table_size'] = $this->language->get('entry_table_size');
		...
		if (isset($this->request->post['table_tip'])) {
			$this->data['table_tip'] = $this->request->post['table_tip'];
		} elseif (!empty($category_info)) {
			$this->data['table_tip'] = $category_info['table_tip'];
		} else {
			$this->data['table_tip'] = 0;
		}
		
		if (isset($this->request->post['table_poverhnost'])) {
			$this->data['table_poverhnost'] = $this->request->post['table_poverhnost'];
		} elseif (!empty($category_info)) {
			$this->data['table_poverhnost'] = $category_info['table_poverhnost'];
		} else {
			$this->data['table_poverhnost'] = 0;
		}
		
		if (isset($this->request->post['table_size'])) {
			$this->data['table_size'] = $this->request->post['table_size'];
		} elseif (!empty($category_info)) {
			$this->data['table_size'] = $category_info['table_size'];
		} else {
			$this->data['table_size'] = 0;
		}
