...
class ControllerSaleOrder extends Controller {
	private $error = array();
  	...
  	private function getList() {
		...
		$this->data['blank'] = $this->url->link('sale/order/blank', 'token=' . $this->session->data['token'], 'SSL');
	...
	public function info() {
		...
		if ($order_info) {
			...
			$this->data['blank'] = $this->url->link('sale/order/blank', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
	...
	public function upload() {
	  ...
	  public function blank() {
		...
		// invoice print
		$this->data['text_order_id_invoice'] = $this->language->get('text_order_id_invoice');
		$this->data['column_product_invoice'] = $this->language->get('column_product_invoice');
		$this->data['column_model_invoice'] = $this->language->get('column_model_invoice');
		$this->data['column_quantity_invoice'] = $this->language->get('column_quantity_invoice');
		$this->data['column_price_invoice'] = $this->language->get('column_price_invoice');
		$this->data['column_total_invoice'] = $this->language->get('column_total_invoice');
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$shipping_data = $this->model_sale_order->getOrderTotalsShipping($order_id);
				$total_data = $this->model_sale_order->getOrderTotalsInvoice($order_id);
		...
		$this->template = 'sale/order_blank.tpl';
