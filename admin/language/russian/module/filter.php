...
$_['entry_filter_group']  = 'Группа филтров:';
$_['entry_position']      = 'Расположение:';
$_['entry_status']        = 'Статус:';
$_['entry_sort_order']    = 'Порядок сортировки:';

// Info
$_['info_count_enabled']  = 'Для магазинов с большим количеством товаров, рекомендуется отключить, чтобы увеличить скорость загрузки.';
