...
class ModelCatalogCategory extends Model {
	public function addCategory($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `table_tip` = '" . (isset($data['table_tip']) ? (int)$data['table_tip'] : 0) . "', `table_poverhnost` = '" . (isset($data['table_poverhnost']) ? (int)$data['table_poverhnost'] : 0) . "', `table_size` = '" . (isset($data['table_size']) ? (int)$data['table_size'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW(), date_added = NOW()");
	...
	public function editCategory($category_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "category SET parent_id = '" . (int)$data['parent_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `table_tip` = '" . (isset($data['table_tip']) ? (int)$data['table_tip'] : 0) . "', `table_poverhnost` = '" . (isset($data['table_poverhnost']) ? (int)$data['table_poverhnost'] : 0) . "', `table_size` = '" . (isset($data['table_size']) ? (int)$data['table_size'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW() WHERE category_id = '" . (int)$category_id . "'");
