...
function addModule() {	
	...
	html += '  <table class="form">';
      ...
      html += '      <td><input type="text" name="testimonial_module[' + module_row + '][testimonial_limit]" value="5" size="2" /></td>';
      html += '  </tr>';
	...
	html += '  </tr>';
      ...
      html += '      <td><input type="text" name="testimonial_module[' + module_row + '][testimonial_character_limit]" value="300" size="2" /></td>';
      html += '  </tr>';
