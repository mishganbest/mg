        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
                ...
                <td><input type="text" name="article_description[<?php echo $language['language_id']; ?>][city]" maxlength="70" size="30" value="<?php echo isset($article_description[$language['language_id']]) ? $article_description[$language['language_id']]['city'] : ''; ?>" /></td>
              </tr>
            <tr>
