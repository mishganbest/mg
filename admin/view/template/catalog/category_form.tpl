      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td><?php echo $entry_table_show; ?></td>
              <td><?php if ($table_tip) { ?>
                <input type="checkbox" name="table_tip" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="table_tip" value="1" />
                <?php } ?> <?php echo $entry_table_tip; ?>
                
                &emsp;<?php if ($table_poverhnost) { ?>
                <input type="checkbox" name="table_poverhnost" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="table_poverhnost" value="1" />
                <?php } ?> <?php echo $entry_table_poverhnost; ?>
                
                &emsp;<?php if ($table_size) { ?>
                <input type="checkbox" name="table_size" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="table_size" value="1" />
                <?php } ?> <?php echo $entry_table_size; ?></td>
            </tr>
