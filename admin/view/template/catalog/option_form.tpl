        ...
        <table id="option-value" class="list">
          ...
          <tbody id="option-value-row<?php echo $option_value_row; ?>">
            <tr>
              ...
              <td class="right"><input type="text" name="option_value[<?php echo $option_value_row; ?>][sort_order]" value="<?php echo $option_value['sort_order']; ?>" size="2" /></td>
...
function addOptionValue() {
	...
	html += '<td class="right"><input type="text" name="option_value[' + option_value_row + '][sort_order]" value="" size="2" /></td>';
